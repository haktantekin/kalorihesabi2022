            ...
            <section class="flex-col mt-4">
              <div class="container">
                <div class="w-full grid gap-x-5 gap-y-8 grid-cols-1 lg:grid-cols-2">
                    ...
                    <a href="/kalori-hesaplama/" class="block w-full h-full">
                      <picture alt="">
                        ...
                        <img class="object-cover h-72 scale-100 hover:scale-105 ease-in duration-200" width="233"
                          ...
                          alt="Kalori Hesaplama">
                      </picture>
                    </a>
                    <a href="/kalori-hesaplama/" class="block w-full h-full mt-5">
                  ...
                  <div class="flex h-full flex-col">
                    <a href="/ideal-kilo-hesaplama/" class="block w-full h-full">
                      <picture alt="İdeal Kilo Hesaplama">
                        <source width="100%" height="100%"
                  ...
                  <div class="flex h-full flex-col">
                    <a href="/kalori-kilo-hesaplama/" class="block w-full h-full">
                      <picture alt="Kalori/Kilo Hesaplama">
                        <source width="100%" height="100%"
