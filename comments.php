    ...
    <?php if (have_comments()) : ?>
        ...
        ?>
            <nav id="comment-nav-below" class="comment-navigation" role="navigation">
                <h1 class="screen-reader-text"><?php _e('Comment navigation', '_mbbasetheme'); ?></h1>
                <div class="nav-previous"><?php previous_comments_link(__('&larr; Eski Yorumlar', '_mbbasetheme')); ?></div>
                <div class="nav-next"><?php next_comments_link(__('Yeni Yorumlar &rarr;', '_mbbasetheme')); ?></div>
